...
| [[Week1-Assignments]]      | แบบฝึกหัด 1.2, 1.4, โจทย์ลบด้วย Complement     | 21, 34, 44-49 |

> [!note] สรุปทบทวนรวม
> [[Week1-Summary]] คือสรุปทบทวนรวมตัวอย่างของสาขาระบบเลขฐาน (การแปลงฐาน, บวก/ลบ, คอมพลีเมนต์) ไว้ในที่เดียว — ไม่ครอบคลุมสาขา Codes และไม่ได้อยู่ใน chain โน้ตหลักด้านบน ใช้เป็นโน้ตทบทวนก่อนสอบได้
